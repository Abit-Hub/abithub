...
const TikTokIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={16} height={16}>
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.32 6.32 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.75a8.23 8.23 0 0 0 4.82 1.55V6.85a4.85 4.85 0 0 1-1.05-.16z" />
  </svg>
);
...
const socialLinks = [
  { href: "https://instagram.com/abithub", label: "Instagram", Icon: InstagramIcon },
  { href: "https://tiktok.com/@abithub", label: "TikTok", Icon: TikTokIcon },
  { href: "https://x.com/abithub", label: "X (Twitter)", Icon: XIcon },
  { href: "https://wa.me/2348153853704", label: "WhatsApp", Icon: WhatsAppIcon },
];
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-2 text-sm text-muted">
                ...
                No. 14 Unity Street, Adjacent to Addin, Along Idi Mango Rd, Soka (New Felele), Ibadan, Oyo State
              </li>
              <li>
                <a
